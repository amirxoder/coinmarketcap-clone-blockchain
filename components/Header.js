...
const styles = {
  ...
  nav: `flex justify-center gap-[20px]`,
  navItem: `relative cursor-pointer hover:opacity-60`,
    ...
    <div className={styles.header}>
      ...
      <div className={styles.headerWrapper}>
        <nav className={styles.nav}>
          ...
          <div className={styles.navItem}>
            <div className={styles.navLink}>Cryptwon</div>
            <div className={styles.badge} />
          </div>
          ...
          <div className={styles.navItem}>
            <div className={styles.navLink}>Peroduchts</div>
            <div className={styles.badge} />
          </div>
